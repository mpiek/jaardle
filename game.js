...
const I18N = {
  nl: {
    ...
    meta_desc: "Jaardle (jaar + Wordle) is een gratis dagelijks jaartal-raadspel in de stijl van Wordle en Yeardle: raad in zes pogingen het jaar van een historische gebeurtenis. Dagelijkse puzzel of vrij spel.",
  ...
  de: {
    ...
    meta_desc: "Jaardle ist ein kostenloses tägliches Jahreszahlen-Ratespiel — das Jahrdle der Geschichte, im Stil von Wordle und Yeardle: errate in sechs Versuchen das Jahr eines historischen Ereignisses. Tägliches Rätsel oder endloses freies Spiel.",
  ...
  es: {
    ...
    meta_desc: "Jaardle es un juego diario y gratuito de adivinar años — el Añodle de la historia, al estilo de Wordle y Yeardle: adivina en seis intentos el año de un acontecimiento histórico. Puzle diario o partida libre infinita.",
  ...
  pt: {
    ...
    meta_desc: "Jaardle é um jogo diário e gratuito de adivinhar anos — o Anodle da história, no estilo de Wordle e Yeardle: adivinhe em seis tentativas o ano de um acontecimento histórico. Quebra-cabeça diário ou jogo livre infinito.",
