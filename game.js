...
const HELP_PT = `
  ...
  <li><strong>Deslize o carrossel para mais dicas</strong> — toque em "Revelar" (custa pontos): <strong>⏩ 100 anos depois</strong> e depois <strong>⏩ 250 anos depois</strong> (acontecimentos posteriores à resposta), <strong>🏛️ era</strong> (o século) e o <strong>🔢 último algarismo</strong> do ano.</li>
...
const I18N = {
  nl: {
    ...
    meta_desc: "Jaardle is een gratis dagelijks jaartal-raadspel in de stijl van Wordle en Yeardle: raad in zes pogingen het jaar van een historische gebeurtenis. Dagelijkse puzzel of vrij spel.",
  ...
  en: {
    ...
    meta_desc: "Jaardle is a free daily year-guessing game in the style of Wordle and Yeardle: guess the year of a historic event in six tries. Daily puzzle or endless free play.",
  ...
  de: {
    ...
    meta_desc: "Jaardle ist ein kostenloses tägliches Jahreszahlen-Ratespiel im Stil von Wordle und Yeardle: errate in sechs Versuchen das Jahr eines historischen Ereignisses. Tägliches Rätsel oder endloses freies Spiel.",
  ...
  es: {
    ...
    meta_desc: "Jaardle es un juego diario y gratuito de adivinar años al estilo de Wordle y Yeardle: adivina en seis intentos el año de un acontecimiento histórico. Puzle diario o partida libre infinita.",
  ...
  pt: {
    ...
    meta_desc: "Jaardle é um jogo diário e gratuito de adivinhar anos no estilo de Wordle e Yeardle: adivinhe em seis tentativas o ano de um acontecimento histórico. Quebra-cabeça diário ou jogo livre infinito.",
